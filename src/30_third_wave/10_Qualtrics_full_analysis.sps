...
/* Select Survey 3 respondents <30; exclude respondents who have taken it before

USE ALL.
COMPUTE filter_$=(age < 30 & taken_before = 1 & time = 0).
VARIABLE LABELS filter_$ 'age < 30 & taken_before = 1 & time = 0 (FILTER)'.
...
USE ALL.
COMPUTE filter_$=(age < 30 & taken_before = 1).
VARIABLE LABELS filter_$ 'age < 30 & taken_before = 1 (FILTER)'.
VALUE LABELS filter_$ 0 'Not Selected' 1 'Selected'.
FORMATS filter_$ (f1.0).
FILTER BY filter_$.
EXECUTE.
