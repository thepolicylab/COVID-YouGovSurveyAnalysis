...
/* Are there question order x 2020 vote interactions?

COMPUTE question_order_by_trump_vote_interaction=mandate_beliefs_before_vaccine_beliefs * 
    trump_vote_dummy_code.
EXECUTE.

USE ALL.
COMPUTE filter_$=(presvote20post < 3).
VARIABLE LABELS filter_$ 'presvote20post < 3 (FILTER)'.
...
REGRESSION
  ...
  /NOORIGIN 
  /DEPENDENT q162_1
  /METHOD=ENTER mandate_beliefs_before_vaccine_beliefs trump_vote_dummy_code 
    question_order_by_trump_vote_interaction.
...
REGRESSION
  ...
  /DEPENDENT q162_1
  /METHOD=ENTER mandate_beliefs_before_vaccine_beliefs trump_vote_dummy_code 
    question_order_by_trump_vote_interaction gender_dummy_coded_female race_dummy_coded_black 
...
MEANS TABLES=q162_1 q162_2 q162_3 q162_4 q162_5 q162_6 q162_7 q162_8 q162_9 BY 
    mandate_beliefs_before_vaccine_beliefs BY trump_vote_dummy_code
