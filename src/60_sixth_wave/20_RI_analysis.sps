...
/* This code should be used with data in TPL_Testing_Survey_SixthWave_YouGov_US.sav
...
FREQUENCIES VARIABLES=gender race educ family_incom_binned_evenly pid3 HDC_tiers
  /ORDER=ANALYSIS.
...
CROSSTABS
  /TABLES=q157 BY gender race educ pid3 presvote20post vaccinated_yes_or_no HDC_tiers
  /FORMAT=AVALUE TABLES
  /STATISTICS=CHISQ 
  /CELLS=COUNT COLUMN 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES=q154 BY gender race educ pid3 presvote20post vaccinated_yes_or_no HDC_tiers
  /FORMAT=AVALUE TABLES
  /STATISTICS=CHISQ 
  /CELLS=COUNT COLUMN 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES=definitely_will_vaccinate_underage_children_or_already_has combined_intention_to_vaccinate_children BY gender race educ pid3 presvote20post vaccinated_yes_or_no HDC_tiers
  /FORMAT=AVALUE TABLES
  /STATISTICS=CHISQ 
  /CELLS=COUNT COLUMN 
  /COUNT ROUND CELL.
